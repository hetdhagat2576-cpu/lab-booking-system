...
const { createContactMessage, getContacts, updateContactStatus, markAsReviewed, deleteContact, clearContactsForUser, getContactsForUser } = require('../controllers/contactController');
...
router.put('/:contactId/mark-reviewed', protect, authorize('admin'), markAsReviewed);
