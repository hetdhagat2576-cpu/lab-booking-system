...
import { FEVER_PACKAGES, RECOMMENDED_TESTS, getTestCount, PACKAGE_TESTS } from "../../../config/staticData";
    ...
    <div className={Theme.layout.standardPage}>
      ...
      <main className="flex-grow bg-slate-50/50">
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
              <div className="space-y-1">
                ...
                <p className="text-slate-500 font-medium text-sm">
                  Key fever diagnostics for rapid clinical decisions
                </p>
              </div>
          ...
          {/* Expert Tip Section */}
          <div className="mt-16 bg-white p-6 md:p-10 rounded-[2rem] shadow-sm border border-red-50 flex flex-col md:flex-row items-center gap-6 md:gap-10">
            <div className="w-20 h-20 bg-red-50 rounded-2xl flex items-center justify-center shrink-0">
