      ...
      try {
        ...
        if (id) {
          try {
            ...
            const response = await debouncedCall(`${process.env.VITE_API_URL || process.env.REACT_APP_API_URL }/api/tests/${id}`);
          ...
          if (!testData && id) {
            try {
              ...
              const fallbackResponse = await debouncedFallbackCall(`${process.env.VITE_API_URL || process.env.REACT_APP_API_URL }/api/tests?isActive=true&limit=1`);
